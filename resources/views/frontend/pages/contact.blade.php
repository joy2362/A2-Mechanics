...
@section('head')
    <meta content="{{$contact_page->meta_description}}" name="description">
    <meta content="{{$contact_tag}}" name="keywords">
    <title>{{$contact_page->title. ' - '.$App_Name}}</title>
@endsection
@section('content')
    <!-- ======= Hero Section ======= -->
    <section class="section-bg section_about">
        <div class="container">
            <div class="col">
                ...
                <h2 class="font-weight-bold text-primary text-center">{{$contact_page->title}}</h2>
                <p class="text-center">{!! $contact_page->sub_title !!}</p>
